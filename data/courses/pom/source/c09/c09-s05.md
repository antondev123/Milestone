...
> **Exhibit 9.6** shows what might be some strategic objectives for Disney. To make people happy (Disney's vision), Disney focuses on entertainment (its mission). Top executives then decide each year what entertainment products the company will offer. Because Disney is a large corporation (more on that shortly), it has a variety of resources available to create entertainment products to offer. For example, they may decide to release three movies this year, as well as build a new theme park and create five new shows for their television network. In reality, the strategic objectives at Disney are much more complex than this, because some of these choices involve long-term efforts (they cannot build a theme park in one year). Exhibit 9.6 A Possible Strategic Path from Vision to Objective for Disney *(figure not included)*
