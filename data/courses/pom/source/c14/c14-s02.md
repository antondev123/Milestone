...
> **Figure** Seattle protester with sign (Credit: Adrenalin Tim /flickr/ Attribution 2.0 Generic (CC BY 2.0)) *(figure not included)*
...
> **Figure 14.2.5** identifies a number of ways in which organizations can help their members satisfy these three needs. *(figure not included)*
...
> **Figure** Jamie Dimon, CEO at JP Morgan Chase, is reported to make $27 million dollars per year, and as CEO has an *(figure not included)*

interesting and intrinsically rewarding job. Starting tellers at a Chase Bank make a reported $36,100 per year and are in a position that has repeated tasks and may not be the most rewarding from a motivational point of view. How does this pay structure relate
