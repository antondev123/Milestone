...
> **Figure** The Planning Process Source: Adapted from H. Koontz and C. O'Donnell, 1972. Principles of management: An analysis of managerial functions. New York: McGraw-Hill, 113. *(figure not included)*
...
> **Figure** Post-it� notes, a 3M product, are often used to create and edit shared documents, such as a company strategic plan. How might technology that allows multiple people to share and edit documents such as Word or PowerPoint files affect the sales of Post-it� products? *(figure not included)*
