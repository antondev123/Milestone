...
1. **The route line is the brand.** A chapter is a taxi route: one stop per leg, a leg being a section of the book (4–8 stops a chapter) and its ~2-minute segments its **parts**. It appears on Resume and Progress. Do not invent other progress visuals.
