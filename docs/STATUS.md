...
<<<<<<< HEAD
Updated: 2026-09-18 (session log + diagnostics pages; Study checkpoint layout and leg/section navigation; Study desktop column tidy; Study assistant mic dictation)
...
=======
Updated: 2026-09-18 (Study desktop scaling + Phone preview; Study desktop column tidy; Study assistant mic dictation; play button fix for Dial and Study; app renamed to Milestone)
...
>>>>>>> ccec64a (Study: scale the desktop layout with the viewport and add a Phone preview)
