...
export default function VoiceMode({ legs, source, carriedFromReading, startId }: { legs: LegIndex; source: string; carriedFromReading: boolean; startId: string }) {
  ...
  return (
    <Screen dark gap="gap-6">
      <TopBar left={back} title={leg ? `Leg ${leg.n} of ${leg.of}` : "Listen"} right={<ModePill to="read" dark onClick={() => router.push("/learn/text")} />} />
